...
public class TestRMServer {
	public static void main(String[] args) {
		while(true) {
			...
			if(choose == 1) {
				new ClusterManagerSender(Config.getRmHost1(),ReplicaManager1.RM_RECEIVE_SEQUENCER_PROT,"2$555$MTL$MTL1111$NDL$20161010$2$2$2$").start();
				new ClusterManagerSender(Config.getRmHost2(),ReplicaManager2.RM_RECEIVE_SEQUENCER_PROT,"2$555$MTL$MTL1111$NDL$20161010$2$2$2$").start();
				new ClusterManagerSender(Config.getRmHost3(),ReplicaManager3.RM_RECEIVE_SEQUENCER_PROT,"2$555$MTL$MTL1111$NDL$20161010$2$2$2$").start();
				new ClusterManagerSender(Config.getRmHost4(),ReplicaManager4.RM_RECEIVE_SEQUENCER_PROT,"2$555$MTL$MTL1111$NDL$20161010$2$2$2$").start();
			}else if(choose == 2) {
				new ClusterManagerSender(Config.getRmHost1(),ReplicaManager1.RM_RECEIVE_SEQUENCER_PROT,"2$556$MTL$MTL1111$NDL$20161010$2$2$2$").start();
				new ClusterManagerSender(Config.getRmHost2(),ReplicaManager2.RM_RECEIVE_SEQUENCER_PROT,"2$556$MTL$MTL1111$NDL$20161010$2$2$2$").start();
...
//				new ClusterManagerSender(Config.getRmHost4(),ReplicaManager4.RM_RECEIVE_SEQUENCER_PROT,"2$6$MTL$MTL1111$NDL$20161010$2$2$2$").start();
				...
				new ClusterManagerSender(Config.getRmHost3(),ReplicaManager3.RM_RECEIVE_SEQUENCER_PROT,"2$557$MTL$MTL1111$NDL$20161010$2$2$2$").start();
				new ClusterManagerSender(Config.getRmHost4(),ReplicaManager4.RM_RECEIVE_SEQUENCER_PROT,"2$557$MTL$MTL1111$NDL$20161010$2$2$2$").start();
			}
		}
	}
}
